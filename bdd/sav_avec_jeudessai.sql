...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : mer. 04 mai 2022 à 10:42
...
(20, 'rue des rillettes', 72000, 'LE MANS', 1);
...
CREATE TABLE IF NOT EXISTS `constituer` (
  ...
  KEY `IdPiece` (`IdPiece`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `diagnostic` (
  ...
  `DateDiag` datetime DEFAULT NULL,
  PRIMARY KEY (`IdDiag`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `diagnostic` (`IdDiag`, `LibDiagnostic`, `DateDiag`) VALUES
('1', 'Remplacement à neuf', '2020-05-15 00:00:00'),
('2', 'Echange de la platine', '2022-11-05 00:00:00'),
('3', 'Remplacement de la batterie', '2020-07-13 00:00:00'),
('4', 'Economiquement irréparable', '2019-03-01 00:00:00'),
('5', 'Remplacement à neuf', '2018-06-22 00:00:00');
...
INSERT INTO `piece` (`IdPiece`, `NomPiece`, `PxPiece`, `StockPhysiquePiece`, `StockRebusPiece`, `StockSAVPiece`, `QtePiece`) VALUES
...
CREATE TABLE IF NOT EXISTS `ticketsav` (
  ...
  `IdDiag` varchar(50) DEFAULT NULL,
...
INSERT INTO `ticketsav` (`IdTicket`, `DateAppelClient`, `DatePEC`, `DateFermTicket`, `Motif`, `Observations`, `IdDiag`, `IdTypeDossier`, `IDTypeInter`, `IdCommande`, `IdTechnicien`) VALUES
(404001, '2020-09-03', '2020-09-05', '2020-10-15', NULL, NULL, NULL, 1, 0, 502116, 1),
(404002, '2020-12-04', '2020-12-10', '2021-01-30', NULL, NULL, NULL, 5, 3, 502117, 2),
(404003, '2021-01-05', '2021-01-09', '2021-03-19', NULL, NULL, NULL, 5, 3, 502118, 3),
(404004, '2021-09-06', '2021-09-16', NULL, NULL, NULL, NULL, 1, 0, 502119, 3),
(404005, '2022-03-07', '2022-03-27', NULL, NULL, NULL, NULL, 2, 0, 502120, 1),
(404006, '2022-02-08', '2022-02-12', NULL, NULL, NULL, NULL, 3, 1, 502121, 2),
(404007, '2022-02-08', '2022-02-15', NULL, NULL, NULL, NULL, 5, 3, 502122, 1),
(404008, '2022-02-08', '2022-02-22', NULL, NULL, NULL, NULL, 5, 3, 502123, 13),
(404009, '2019-09-11', '2019-09-18', '2019-10-08', NULL, NULL, NULL, 1, 0, 502124, 10),
(404010, '2019-09-12', '2019-09-14', '2020-03-14', NULL, NULL, NULL, 1, 0, 502125, 11),
(404011, '2020-09-13', '2020-09-22', '2020-12-02', NULL, NULL, NULL, 2, 0, 502126, 12),
(404012, '2021-11-14', '2021-11-22', NULL, NULL, NULL, NULL, 3, 1, 502127, 13),
(404013, '2020-05-15', '2020-05-23', '2020-07-03', NULL, NULL, NULL, 4, 2, 502128, 14),
(404014, '2020-06-16', '2020-06-28', '2020-10-08', NULL, NULL, NULL, 5, 3, 502129, 15),
(404015, '2017-09-17', '2017-10-03', '2017-11-23', NULL, NULL, NULL, 5, 3, 502130, 11),
(404016, '2020-11-18', '2020-11-22', '2021-01-20', NULL, NULL, NULL, 5, 3, 502131, 12),
(404017, '2022-01-19', '2022-01-27', '2022-04-07', NULL, NULL, NULL, 2, 0, 502132, 16),
(404018, '2020-02-20', '2020-03-01', '2020-03-21', NULL, NULL, NULL, 3, 1, 502133, 17),
(404019, '2021-07-21', '2021-08-02', NULL, NULL, NULL, NULL, 4, 1, 502134, 17),
(404020, '2018-10-22', '2018-10-29', '2018-12-31', NULL, NULL, NULL, 5, 3, 502135, 18),
(404021, '2018-10-01', '2018-10-30', '2018-12-20', NULL, NULL, NULL, 5, 3, 502135, 19);
...
ALTER TABLE `constituer`
  ...
  ADD CONSTRAINT `constituer_ibfk_2` FOREIGN KEY (`IdPiece`) REFERENCES `piece` (`IdPiece`);
...
-- ALTER TABLE `ticketsav`
  -- ADD CONSTRAINT `ticketsav_ibfk_1` FOREIGN KEY (`IdDiag`) REFERENCES `diagnostic` (`IdDiag`),
  -- ADD CONSTRAINT `ticketsav_ibfk_2` FOREIGN KEY (`IdTypeDossier`) REFERENCES `type_dossier` (`IdTypeDossier`),
  -- ADD CONSTRAINT `ticketsav_ibfk_3` FOREIGN KEY (`IDTypeInter`) REFERENCES `typeinter` (`IDTypeInter`),
  -- ADD CONSTRAINT `ticketsav_ibfk_4` FOREIGN KEY (`IdCommande`) REFERENCES `commande` (`IdCommande`),
  -- ADD CONSTRAINT `ticketsav_ibfk_5` FOREIGN KEY (`IdTechnicien`) REFERENCES `technicien` (`IdTechnicien`);
COMMIT;
