...
<body>
    <header>
        <div class="row"> 
        <?php if (($action != 'connexion') && ($action != 'deconnexion')){?><div class="connexion text-end"><i class="bi bi-person-circle"></i><?php echo " " . $prenomConnecte . " " . $nomConnecte ?> est connecté(e) !
